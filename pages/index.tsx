      ...
      <section className="bg-white">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl ">
            Gather Feedback and Reward your Web3 Community
          </h1>
          <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 ">
            Solform allows your to gather community feedback via a no-code form
            building and distributing platform, as well as reward your community
            with NFTs, token and airdrops
          </p>
          <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a
              href="/sign-up"
              className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center rounded-lg text-white bg-blue-500 hover:bg-blue-600 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 "
            >
              Get Started
              <svg
                className="ml-2 -mr-1 w-5 h-5"
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-sm text-center">
            ...
            <p className="mb-6 font-light text-gray-500  md:text-lg">
              Start gathering insights and rewarding your community today with
              Solform.
            </p>
